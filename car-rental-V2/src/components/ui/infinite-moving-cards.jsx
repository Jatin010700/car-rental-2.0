  ...
  return (
    <div
      ...
      <ul
        ...
        {items.map((item, idx) => (
          <li
            className={`${bgColors[idx % bgColors.length]} relative w-[350px] max-w-full shrink-0 rounded-2xl border-2 border-L-black  px-8 py-6 md:w-[450px] dark:border-L-black dark:bg-[linear-gradient(180deg,#27272a,#18181b)]`}
            key={item.name}>
            <blockquote>
              <div
                aria-hidden="true"
