  ...
  return (
    <div className="bg-white">
      <section className="dark:bg-gray-800 dark:text-gray-100">
        <div className="container px-6 pt-0 pb-12  mx-auto">
          <div className="grid items-center gap-4 xl:grid-cols-5">
            <div className="max-w-2xl mx-auto my-8 space-y-4 text-center xl:col-span-2 xl:text-left">
              <h1 className="text-center font-bold text-4xl p-4">
                <span className="underline-rounded">Reviews</span>
              </h1>
            ...
            <div className="py-0 px-0 md:!py-6 xl:col-span-3">
                ...
                <div className="grid content-center gap-2 md:!gap-4">
                  <div className="p-6 rounded-2xl shadow-md bg-L-black text-white">
                    ...
                    <div className="flex items-center mt-4 space-x-4">
                      <img src={rev3} alt="" className="w-12 h-12 bg-center bg-cover rounded-full dark:bg-gray-500" />
                      <div>
                  ...
                  <div className="p-6 rounded-2xl shadow-md bg-yellow ">
                    ...
                    <div className="flex items-center mt-4 space-x-4">
                      <img src={rev3} alt="" className="w-12 h-12 bg-grey rounded-full dark:bg-gray-500"/>
                      <div>
                        <p className="text-lg font-semibold">Ameliah</p>
                        <p className="text-sm dark:text-gray-400">
                          Software Developer
